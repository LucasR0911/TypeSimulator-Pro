...
namespace TypeSimulator.Models
{
    ...
    public class Settings
    {
        ...
        public bool EnableTypoSimulation { get; set; }
        public int TypoChancePercent { get; set; }
        public int DoubleHitChancePercent { get; set; }
        ...
        public int FatigueCurveStrengthPercent { get; set; }
        ...
        public Settings()
        {
            ...
            FatigueCurveStrengthPercent = 100;
